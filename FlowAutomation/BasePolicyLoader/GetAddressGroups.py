...
"""
The purpose of this script is to get a list of Address Groups and their UUID
...
logfile_name = file_path + '\\GetAddressGroups.' + log_time + '.log'
print (f'Logfile: {logfile_name}')
logfile = open(logfile_name, 'w')

output_file = file_path + '\\AddressList.' + log_time + '.csv'
...
if resp.ok:
    ...
    while iterator <= iterations:
        ...
        for value in json.loads(resp.content)['entities']:
            if 'name' in value['address_group']:
                value_name = value['address_group']['name']
            else:
                value_name = "No Name"
            ...
            outfile.write(f'{value_name},{value_uuid}\n')
